...
ThunderJira only performs **read** operations (projects, issues, users, labels) and **write** operations (create issues, upload image attachments, edit issue descriptions to embed those images, ~~add comments~~). It does **not** delete or administer any Jira resource.
