...
| `attachmentsWarning` | `ref<string\|null>` | Set when the issue was created but an image upload or the description edit failed (text-only description used as fallback) |
